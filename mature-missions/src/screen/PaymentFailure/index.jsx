 ...
 * Description: Component for displaying a fail message after a failed payment.
 */
            ...
            <div className="about-component">
                <div className='about-content'>
                    ...
                    <div className='success-fail-component'>
                        ...
                        <div>Your payment failed. Please enter other payment details or contact admin.</div>
                    </div>
                    <Footer />
                </div>
            </div>
